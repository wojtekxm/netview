        ...
        <div class="form-group">
            <form method="post" action="AddController">
                <center><input type="text" class="form-control" placeholder="Nazwa Kontrolera" onkeyup="nospaces(this)"
                               required="required" name="name" value="" autocorrect="off"></center>
                <center><input type="text" class="form-control" placeholder="Adres IPv4" onkeyup="nospaces(this)"
                               required="required" name="ipv4" value="" autocorrect="off"></center>
                <center><input type="text" class="form-control" placeholder="Komentarz (opcjonalne)"
                               onkeyup="nospaces(this)" required="required" name="description" value=""
                               autocorrect="off"></center>
                <p></p>
                <center><input type="submit" value="Dodaj kontroler" class="btn btn-primary btn-default btn-lg active">
                </center>
                <p></p>
                <center><a href="javascript:history.back();"><input type="button" value="Wstecz"
                                                                    class="btn btn-primary btn-default btn-lg active"></A>
                </center>
            </form>
            <br></div>
    </div>
