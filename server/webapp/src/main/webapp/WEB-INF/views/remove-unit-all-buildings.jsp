...
<div id="all" class="container-fluid">
    <div id="container">
        <div class="content">
            <div>
                <div id="wydzial"><div style="border-bottom: 1px solid #e0e0e0;padding-bottom: 3px;"><span class="glyphicon glyphicon-th-list"></span> Kliknij budynek, z którym chcesz usunąć powiązanie :</div></div>
            </div>
