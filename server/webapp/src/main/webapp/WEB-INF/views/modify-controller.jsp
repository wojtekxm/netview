        ...
        <div class="content">
            ...
            <div id="devices" class="panel panel-default" style="padding: 15px;">
                ...
                <div>
                    ...
                    <a href="/controller/${controller.id}" class="btn btn-info" role="button" style="float:left;width:180px;font-size:17px;" ><span class="glyphicon glyphicon-backward"></span> Powrót</a>
